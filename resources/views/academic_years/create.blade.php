                ...
                <form method="POST" action="{{ route('academic-years.store') }}" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-xs font-extrabold text-slate-700 uppercase tracking-wider mb-2">
                            Intitulé de l'Année (ex: 2025-2026)
                        </label>
                        <input type="text" name="name" required placeholder="2025-2026"
                               value="{{ old('name') }}"
                    ...
                    <div class="p-4 bg-purple-50 rounded-2xl border border-purple-100 flex items-center justify-between">
                        <div>
                            ...
                            <span class="text-xs text-purple-700">Cette année deviendra l'année de référence globale pour tout l'établissement.</span>
                        </div>
